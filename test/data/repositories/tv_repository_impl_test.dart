...
void main() {
  ...
  group('Get Series Detail', () {
    final tId = 6;
    final tSeriesResponse = TvSeriesDetailModel(
      adult: false,
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      ...
      // act
      final result = await repository.saveWatchlistSeries(testTVDetail);
      // assert
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      ...
      // act
      final result = await repository.removeWatchlistSeries(testTVDetail);
      // assert
